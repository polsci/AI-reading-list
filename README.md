...
Through training to be next word predictors, LLMs learn a representation of language that encodes knowledge about the world. This can be factual, human beliefs and biases, frequent associations, and so on. While it is possible to get accurate claims from an LLM, a key issue with LLMs is their tendency to "hallucinate", or make things up, expressing this "bullshit" (i.e. information communicated without regard for truth). They "bullshit" in a plausible way that can fool the user.   
...
Research on a previous generation of language models (word embeddings) demonstrated stereotypes related to gender and ethnicity learned from the huge amount of text used in training. Modern LLMs, while more complex, demonstrate similar social biases and stereotypes, which are robust to attempts to mitigate them being output. I've also included an article examining cognitive biases in LLMs normally associated with human thinking.  
...
Users of LLM-based chatbots note their helpfulness, agreeableness, or plain sycophancy. The first article conects this to training LLMs on human feedback. The second, is an older study that is relevant to understand the impact on human users. The final article from the American Psychological Association discusses some of the psychological impacts of sycophancy (and other aspects of emotional connection) on people using AI chatbots.  
...
The "Stochastic Parrots" paper above is a good starting point on some of the issues with massive text data used to train LLMs. Here is another interesting work on LLM training data: 
...
Leaks of system prompts provide insight into the personality/vibe of chatbots and other AI systems. I haven't found academic research that digs into system prompts, but the second article provides analysis of the content and composition of system prompts. I agree with their conclusion: "System Prompts Deserve More Attention".  
...
Some starting points on the environmental impact of AI.  
...
LLMs are made by people and used by people. I will expand this at some point, but these links provide examples of some of the human harms associated with the production of LLMs and the use of AI.  
...
LLMs are trained to follow instructions, but this makes it difficult to secure LLM-based systems. Generative AI's succeptibility to prompt injection and other hacking is an issue I want students to know about. We can understand "hacking AI" in a broader sense beyond illegality and malice, to manipulation of AI as a technological system. We're already seeing attempts by users to manipulate generative AI job screening systems and there is growing awareness of the succeptibility of LLM-based systems to manipulation. Understanding that LLM-based systems are prone to manipulation/hacking through natural language:  

1. balances our perception of generative AI as "smart", inevitable, and super-human;  
...
4. can be a way to think more broadly about the possibility that individuals and collectives can resist and oppose harmful AI systems pointed at us.  
